...
HD_PWD='C:/Users/User/DSD_Lab/Final/DSD_final_project/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_CNN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_CNN.tcl
