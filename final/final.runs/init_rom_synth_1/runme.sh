...
HD_PWD='C:/Users/User/DSD_Lab/Final/DSD_final_project/final/final.runs/init_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log init_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source init_rom.tcl
