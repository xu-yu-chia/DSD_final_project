...
HD_PWD='C:/Users/User/DSD_Lab/Final/DSD_final_project/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_CNN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_CNN.tcl -notrace
